...
### how to use?
put your images in the "in" folder and use geometrize.bat or geometrized_advanced.bat for more options, after the process is complete the converted images can be found in the "out" folder
